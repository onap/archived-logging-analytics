...
#     Rancher 1.6.22, Kubernetes 1.11.2, kubectl 1.11.2, Helm 2.9.1, Docker 17.03
...
-o [os]             : rhel=RHEL/CENTOS, ubuntu=ubuntu (default ubuntu)
...
while getopts ":b:s:e:u:c:a:l:o:v" PARAM; do
  case $PARAM in
    u)
      usage
      exit 1
